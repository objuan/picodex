...
//     <id value="$Id: VertexIndexData.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
	...
	public class HardwareAnimationData
	{
		...
		public VertexElement TargetVertexElement { get { return targetVertexElement; } set { targetVertexElement = value; } }

		public float Parametric { get { return parametric; } set { parametric = value; } }
	}
	...
	public class VertexData : DisposableObject
	{
			...
			*/
			...
			if( posElem != null )
			{
				...
				if( wasSharedBuffer )
				{
					...
					UnityEngine.Debug.Assert( newRemainderBuffer.VertexSize == ( prePosVertexSize + postPosVertexSize ) );
		...
		public void AllocateHardwareAnimationElements( ushort count )
		{
			...
			UnityEngine.Debug.Assert( texCoord <= Config.MaxTextureCoordSets );
