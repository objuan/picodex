...
//     <id value="$Id: MovablePlane.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
	...
	public class MovablePlane : MovableObject, IDerivedPlaneProvider
	{
		...
		/// </summary>
		public float D { get { return containedPlane.D; } set { containedPlane.D = value; } }

		/// <summary>
		///		The direction the plane is facing.
		/// </summary>
		public Vector3 Normal { get { return containedPlane.Normal; } set { containedPlane.Normal = value; } }
		...
		public override AxisAlignedBox BoundingBox { get { return nullBB; } }

		public override float BoundingRadius { get { return float.PositiveInfinity; } }
