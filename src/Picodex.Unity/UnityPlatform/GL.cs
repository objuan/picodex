    ...
    public static class GL
    {
       ...
       //  Static Variables
        ...
        public static void Begin(int mode)
        {
            switch (mode)
            {
                case 0: OGL.Begin(OpenTK.Graphics.OpenGL.PrimitiveType.Lines); break;
                case 1: OGL.Begin(OpenTK.Graphics.OpenGL.PrimitiveType.Quads); break;
                case 2: OGL.Begin(OpenTK.Graphics.OpenGL.PrimitiveType.TriangleStrip); break;
                case 3: OGL.Begin(OpenTK.Graphics.OpenGL.PrimitiveType.Triangles); break;
            }
