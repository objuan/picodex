...
namespace Picodex
{
    ...
    [AddComponentMenu("Vxcm/VXCMObject")]
    [ExecuteInEditMode]
    public class VXCMObject : MonoBehaviour
    {
        [Range(0, 1)]
...
//#endif
        public void UpdateMat()
        {
            ...
            {
                // resize Proxy
                GetComponent< VXCMObjectProxy>().Rebuild();
          ...
          //  GetComponent<VXCMObjectProxy>().UpdateFromCamera(transform, Camera.current);
