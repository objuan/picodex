...
namespace UnityEngine
{
    ...
    public class Transform : Component, System.Collections.IEnumerable
    {
      ...
      //  InverseTransformVector Transforms a vector from world space to local space. The opposite of Transform.TransformVector. 
        ...
        public void SetDirection(float x, float y, float z, Space relativeTo, Vector3 localDirectionVector)
        {
            Vector3 dir;
            dir.x = x;
            dir.y = y;
        ...
        {
            SetDirection(x, y, z, Space.Self, Vector3.NegativeUnitZ);
        }

        public void SetDirection(float x, float y, float z, Space relativeTo)
        {
        ...
        ///	</param>
        public void SetDirection(Vector3 vec, Space relativeTo, Vector3 localDirection)
        {
        ...
        {
            SetDirection(vec, Space.Self, Vector3.NegativeUnitZ);
        }

        public void SetDirection(Vector3 vec, Space relativeTo)
        {
        ...
        {
            Translate(translate, Space.World);
        }
        ...
        /// </summary>
        /// <param name="scale">Vector with x,y,z values representing the translation.</param>
        virtual public void Translate(Vector3 translate, Space relativeTo)
        {
        ...
        ///	</param>
        /// <param name="move">Vector relative to the supplied axes.</param>
        virtual public void Translate(Matrix3 axes, Vector3 move, Space relativeTo)
        {
            Vector3 derived = axes * move;
        ...
        {
            Rotate(Quaternion.Euler(eulerAngles.x, eulerAngles.y, eulerAngles.z), Space.Self);
        }


        public void Rotate(Quaternion rot, Space relativeTo)
        {
        ...
        virtual public void Pitch(float degrees, Space relativeTo)
        {
        ...
        {
            Rotate(Vector3.UnitX, degrees, Space.Self);
        }
        ...
        /// </summary>
        /// <param name="degrees"></param>
        virtual public void Roll(float degrees, Space relativeTo)
        {
        ...
        {
            Rotate(Vector3.UnitZ, degrees, Space.Self);
        }
        ...
        /// </summary>
        /// <param name="degrees"></param>
        virtual public void Yaw(float degrees, Space relativeTo)
        {
        ...
        {
            Rotate(Vector3.UnitY, degrees, Space.Self);
        }

        /// <summary>
        /// Rotate the node around an arbitrary axis.
        /// </summary>
        virtual public void Rotate(Vector3 axis, float degrees, Space relativeTo)
        {
        ...
        {
            Rotate(axis, degrees, Space.Self);
        }
        ...
        {
            Rotate(axis, angleDegrees, Space.Self);
        }
