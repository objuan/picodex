...
namespace Picodex.Render.Unity
{
    ...
    public struct BezierCurve
    {
        ...
        public static Vector2 CalculatePoint(IList<Vector2> points, float t, float parallel)
        {
            ...
            {
                temp = (float)Mathf.BinomialCoefficient(points.Count - 1, i) * (float)(System.Math.Pow(t, i) *
        ...
        private static Vector2 CalculatePointOfDerivative(IList<Vector2> points, float t)
        {
            ...
            foreach (Vector2 pt in points)
            {
                temp = (float)Mathf.BinomialCoefficient(points.Count - 2, i) * (float)(System.Math.Pow(t, i) *
