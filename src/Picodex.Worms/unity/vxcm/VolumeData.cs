...
namespace Picodex.Unity.Vxcm
{
	...
	public abstract class VolumeData : ScriptableObject
	{
	    ...
	    public virtual VolumeRegion Region
	    {
	        get
			{			
				VolumeRegion result = new VolumeRegion(0, 0, 0, 0, 0, 0);		
				return result;
			}
	    }
		 ...
		 */
		public static VolumeDataType CreateEmptyVolumeData<VolumeDataType>(VolumeRegion region, string pathToVoxelDatabase = null) where VolumeDataType : VolumeData
		{			
			VolumeDataType volumeData = ScriptableObject.CreateInstance<VolumeDataType>();
