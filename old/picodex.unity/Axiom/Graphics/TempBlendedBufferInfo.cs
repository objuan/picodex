...
//     <id value="$Id: TempBlendedBufferInfo.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
	...
	public class TempBlendedBufferInfo : IHardwareBufferLicensee
	{
		...
		public void ExtractFrom( VertexData sourceData )
		{
			...
			if( destPositionBuffer != null )
			{
				...
				UnityEngine.Debug.Assert( destPositionBuffer == null );
			}
			if( destNormalBuffer != null )
			{
				mgr.ReleaseVertexBufferCopy( destNormalBuffer );
				UnityEngine.Debug.Assert( destNormalBuffer == null );
			}
			...
			UnityEngine.Debug.Assert( posElem != null, "Positions are required" );
