...
namespace UnityEngine
{
    ...
    public struct Color : IComparable
    {
        ...
        {
            Axiom.Utilities.Contract.Requires(a >= 0.0f && a <= 1.0f);
            Axiom.Utilities.Contract.Requires(r >= 0.0f && r <= 1.0f);
            Axiom.Utilities.Contract.Requires(g >= 0.0f && g <= 1.0f);
            Axiom.Utilities.Contract.Requires(b >= 0.0f && b <= 1.0f);
        ...
        /// Copy constructor.
        /// </summary>
        /// <param name="other">The Color instance to copy</param>
        ...
        public static Color Parse_0_255_String(string parsableText)
        {
            ...
            {
                throw new FormatException("The parts of the Color in Parse_0_255 must be integers");
            }
            return retVal;
        }
        ...
        /// </summary>
        /// <param name="obj">An instance of a Color object to compare to this instance.</param>
        ...
        //    public float r { get { return value[0]; } set { this.value[0] = value; } }
        //    public float g { get { return value[1]; } set { this.value[1] = value; } }
        //    public float b { get { return value[2]; } set { this.value[2] = value; } }
        //    public float a { get { return value[3]; } set { this.value[3] = value; } }
        //   public float gamma; // A version of the color that has had the gamma curve applied. 
        //  public float grayscale; //  The grayscale value of the color. (Read Only) 
        //  public float linear; //  A linear value of an sRGB color. 
        ...
        public float getHash() // for fast compare
        {
            return r + g * 2 + b * 4 + a * 8;
        }
