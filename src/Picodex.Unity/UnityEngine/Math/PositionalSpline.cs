...
namespace UnityEngine
{
	...
	public sealed class PositionalSpline : Spline<Vector3>
	{
		...
		{
			Axiom.Utilities.Contract.Requires( index >= 0, "index", "Spline point index underrun." );
            Axiom.Utilities.Contract.Requires(index < pointList.Count, "index", "Spline point index overrun.");
			...
			// Algorithm is result = powers * hermitePoly * Matrix4x4(point1, point2, tangent1, tangent2)
