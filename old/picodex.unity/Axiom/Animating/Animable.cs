...
namespace Axiom.Animating
{
	...
	///     AnimableSystem.Object in order to expose it's animable properties.
	///     
...
#endif
	abstract public class AnimableValue
	{
		protected AnimableType type;
		protected System.Object valueObject;
		...
		public AnimableType Type { get { return type; } set { type = value; } }

		public System.Object ValueObject { get { return ValueObject; } set { ValueObject = value; } }

		/// Internal method to set a value as base
		virtual public void SetAsBaseValue( int val )
		{
			valueObject = val;
		}

		/// Internal method to set a value as base
		virtual public void SetAsBaseValue( float val )
		{
			valueObject = val;
		}

		/// Internal method to set a value as base
		virtual public void SetAsBaseValue( Vector2 val )
		{
			valueObject = val;
		}

		/// Internal method to set a value as base
		virtual public void SetAsBaseValue( Vector3 val )
		{
			valueObject = val;
		}

		/// Internal method to set a value as base
		virtual public void SetAsBaseValue( Vector4 val )
		{
			valueObject = val;
		}

		/// Internal method to set a value as base
		virtual public void SetAsBaseValue( Quaternion val )
		{
			valueObject = val;
		}

		/// Internal method to set a value as base
		virtual public void SetAsBaseValue( ColorEx val )
		{
			valueObject = val.Clone();
		}

		private void SetAsBaseValue( System.Object val )
		{
			switch( type )
			{
		...
		public static System.Object InterpolateValues( float time, AnimableType type, System.Object k1, System.Object k2 )
		{
			switch( type )
			{
				case AnimableType.Int:
					int i1 = (int)k1;
					int i2 = (int)k2;
					return (System.Object)(int)( i1 + ( i2 - i1 ) * time );
				case AnimableType.Float:
					float f1 = (float)k1;
					float f2 = (float)k2;
					return (System.Object)( f1 + ( f2 - f1 ) * time );
				case AnimableType.Vector2:
					Vector2 v21 = (Vector2)k1;
					Vector2 v22 = (Vector2)k2;
					return (System.Object)( v21 + ( v22 - v21 ) * time );
				case AnimableType.Vector3:
					Vector3 v31 = (Vector3)k1;
					Vector3 v32 = (Vector3)k2;
					return (System.Object)( v31 + ( v32 - v31 ) * time );
				case AnimableType.Vector4:
					Vector4 v41 = (Vector4)k1;
					Vector4 v42 = (Vector4)k2;
					return (System.Object)( v41 + ( v42 - v41 ) * time );
				case AnimableType.Quaternion:
					Quaternion q1 = (Quaternion)k1;
					Quaternion q2 = (Quaternion)k2;
					return (System.Object)( q1 + ( q2 + ( -1 * q1 ) ) * time );
				case AnimableType.ColorEx:
					ColorEx c1 = (ColorEx)k1;
					ColorEx c2 = (ColorEx)k2;
					return (System.Object)( new ColorEx( c1.a + ( c2.a - c1.a ) * time,
					                              c1.r + ( c2.r - c1.r ) * time,
					                              c1.g + ( c2.g - c1.g ) * time,
					                              c1.b + ( c2.b - c1.b ) * time ) );
			}
		...
		public static System.Object MultiplyFloat( AnimableType type, float v, System.Object k )
		{
			switch( type )
			{
				case AnimableType.Int:
					return (System.Object)(int)( ( (int)k ) * v );
				case AnimableType.Float:
					float f = (float)k;
					return (System.Object)( f * v );
				case AnimableType.Vector2:
					Vector2 v2 = (Vector2)k;
					return (System.Object)( v2 * v );
				case AnimableType.Vector3:
					Vector3 v3 = (Vector3)k;
					return (System.Object)( v3 * v );
				case AnimableType.Vector4:
					Vector4 v4 = (Vector4)k;
					return (System.Object)( v4 * v );
				case AnimableType.Quaternion:
					Quaternion q = (Quaternion)k;
					return (System.Object)( q * v );
				case AnimableType.ColorEx:
					ColorEx c = (ColorEx)k;
					return (System.Object)( new ColorEx( c.a * v, c.r * v, c.g * v, c.b * v ) );
			}
			throw new Exception( string.Format( "In AmiableValue.InterpolateValues, unknown type {0}", type ) );
		}
		...
		/// Sets the current state as the 'base' value; used for delta animation
		/// Any instantiated derived class must implement this guy
		abstract public void SetCurrentStateAsBaseValue();
	}
