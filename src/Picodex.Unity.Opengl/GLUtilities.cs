...
//     <id value="$Id: GLUtilities.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.OpenGL
{
	internal static class GLUtilities
	{
		...
		{
			return GlCheckError( caller, false );
		}
...
#if DEBUG
			LogManager.Instance.Write( string.Format( "OpenGL error {0} from {1}", e, caller.ToString() ) );
#endif
			return e;
		}
	}
