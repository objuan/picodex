...
//     <id value="$Id: SceneNode.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
	...
	public class SceneNode : Node
	{
		...
		/// </summary>
        protected Vector3 autoTrackLocalDirection = Vector3.CameraForward;
		...
		{
            LookAt(target, relativeTo, Vector3.CameraForward);
		}
		...
		{
            SetAutoTracking(enabled, target, Vector3.CameraForward, Vector3.Zero);
		}

		public void SetAutoTracking( bool enabled )
		{
            SetAutoTracking(enabled, null, Vector3.CameraForward, Vector3.Zero);
		}
		...
		public void SetDirection( Vector3 vec, TransformSpace relativeTo, Vector3 localDirection )
		{
            ...
            if (localDirection == Vector3.CameraForward)
            {
                zAdjustVec = -vec;
            }
            else
