...
namespace Axiom.Scripting.Compiler
{
	...
	public partial class ScriptCompiler
	{
		...
		private void InitializeWordMap()
		{
            ...
            // unity, case sensitive ??
            _keywordMap["shader"] = (uint)Keywords.ID_SHADER;
            _keywordMap["Shader"] = (uint)Keywords.ID_SHADER;
            _keywordMap["subShader"] = (uint)Keywords.ID_SUBSHADER;
            _keywordMap["SubShader"] = (uint)Keywords.ID_SUBSHADER;
            _keywordMap["CGPROGRAM"] = (uint)Keywords.ID_CGPROGRAM;
            _keywordMap["Tags"] = (uint)Keywords.ID_TAGS;
            _keywordMap["Properties"] = (uint)Keywords.ID_PROPERTIES;
            _keywordMap["Pass"] = (uint)Keywords.ID_UPASS;
