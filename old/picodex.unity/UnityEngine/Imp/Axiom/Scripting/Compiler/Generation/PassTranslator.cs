						...
						switch( (Keywords)prop.Id )
						{
							...
							case Keywords.ID_AMBIENT:
								...
								else
								{
									...
									{
										UnityEngine.Color val = UnityEngine.Color.White;
							...
							case Keywords.ID_SPECULAR:
								...
								else
								{
									    ...
									    ( (AtomAbstractNode)prop.Values[ 0 ] ).Id == (uint)Keywords.ID_VERTEX_COLOUR )
									{
										...
										{
											float val = 0;
											if( getfloat( prop.Values[ prop.Values.Count - 1 ], out val ) )
											{
												_pass.Shininess = val;
											}
											else
									...
									else
									{
										...
										else
										{
											...
											UnityEngine.Color val = new UnityEngine.Color( 0, 0, 0, 0 );
							...
							case Keywords.ID_FOG_OVERRIDE:
								...
								else
								{
									...
									if( getBoolean( prop.Values[ 0 ], out val ) )
									{
										...
										UnityEngine.Color clr = UnityEngine.Color.White;
