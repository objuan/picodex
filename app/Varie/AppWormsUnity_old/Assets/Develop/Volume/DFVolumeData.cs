...
namespace Picodex.Volume
{
	 ...
	 * 
	 * \sa TerrainVolumeData, DFVolumeData
	 */
	[System.Serializable]
	public class DFVolumeData : ScriptableObject
	{
        ...
        public virtual VolumeRegion Region
        {
            get
            {
		 ...
		 */
		public static VolumeDataType CreateEmptyVolumeData<VolumeDataType>(VolumeRegion region, string pathToVoxelDatabase = null) where VolumeDataType : DFVolumeData
		{			
			VolumeDataType volumeData = ScriptableObject.CreateInstance<VolumeDataType>();
			...
			if(String.IsNullOrEmpty(pathToVoxelDatabase))
			{
                ...
                string pathToCreateVoxelDatabase = Picodex.Utility.GenerateRandomVoxelDatabaseName();
			...
			volumeData.InitializeEmptyVolume(region);
        ...
        protected void InitializeEmptyVolume(VolumeRegion region)
        {
