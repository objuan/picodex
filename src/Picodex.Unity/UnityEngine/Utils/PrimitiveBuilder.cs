...
namespace UnityEngine
{
    ...
    public class PrimitiveBuilder
    {
        public static Mesh CreateMesh(PrimitiveType type)
        {
            ...
            {
                BuildCube(mesh, 1, 1, 1);
            }
            else if (type == PrimitiveType.Plane)
            {
                BuildPlane(mesh, 1, 1, 2, 2);
            }
            ...
            {
                BuildCone(mesh, 1, 0.5f, 0.5f, 18, 1);
            }
            else if (type == PrimitiveType.Tube)
            {
                BuildTube(mesh, 1, 24, 0.5f, .15f, 0.5f, .15f);
            }
            else if (type == PrimitiveType.Torus)
            {
                BuildTorus(mesh, 1, 0.3f, 24,18);
            }
            else if (type == PrimitiveType.Sphere)
            {
                BuildSphere(mesh, 1, 24,16);
            }
        ...
        public static void BuildPlane(Mesh mesh, float length, float width, int resX, int resZ)
        {
        ...
        public static void BuildCube(Mesh mesh, float length, float width, float height)
        {
            // You can change that line to provide another MeshFilter
            ...
            int[] triangles = new int[]
{
	...
	3 + 4 * 5, 2 + 4 * 5, 1 + 4 * 5,
        ...
        public static void BuildCone(Mesh mesh, float height, float bottomRadius, float topRadius, int nbSides, int nbHeightSeg)
        {
            //    MeshFilter filter = gameObject.AddComponent<MeshFilter>();
            //  Mesh mesh = filter.mesh;
            mesh.Clear();
        ...
        public static void BuildTube(Mesh mesh, float height, int nbSides,
            float bottomRadius1, float bottomRadius2, float topRadius1, float topRadius2)
        {
            //  MeshFilter filter = gameObject.AddComponent<MeshFilter>();
            // Mesh mesh = filter.mesh;
            mesh.Clear();
        ...
        public static void BuildTorus(Mesh mesh, float radius1, float radius2, int nbRadSeg, int nbSides)
        {
           // MeshFilter filter = gameObject.AddComponent<MeshFilter>();
          //  Mesh mesh = filter.mesh;
            mesh.Clear();
        ...
        public static void BuildSphere(Mesh mesh, float radius, int nbLong, int nbLat)
        {
          //  MeshFilter filter = gameObject.AddComponent<MeshFilter>();
         //   Mesh mesh = filter.mesh;
            mesh.Clear();
