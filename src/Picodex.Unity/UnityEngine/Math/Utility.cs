...
using Contract = Axiom.Utilities.Contract;
...
namespace UnityEngine
{
	public sealed class Utility
	{
        ...
        //public static float Sin(Real angle)
        //{
        //    return (float)System.Math.Sin((double)angle);
        //}
		...
		/// <returns></returns>
		public static Matrix4x4 BuildReflectionMatrix( Plane plane )
		{
		...
		public static IntersectResult Intersects( Ray ray, PlaneBoundedVolume volume )
		{
			...
			Axiom.Math.Collections.PlaneList planes = volume.planes;
