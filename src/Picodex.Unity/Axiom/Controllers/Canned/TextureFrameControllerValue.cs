...
//     <id value="$Id: TextureFrameControllerValue.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Axiom.Controllers.Canned
{
	...
	public class TextureFrameControllerValue : IControllerValue<float>
	{
		...
		/// </remarks>
		public float Value { get { return texUnit.CurrentFrame / texUnit.NumFrames; } set { texUnit.CurrentFrame = (int)( value * texUnit.NumFrames ); } }
