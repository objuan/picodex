...
//     <id value="$Id: Viewport.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Axiom.Core
{
	...
	public sealed class Viewport
	{
		...
		{
			UnityEngine.Debug.Assert( camera != null, "Cannot use a null Camera to create a viewport." );
			UnityEngine.Debug.Assert( target != null, "Cannot use a null RenderTarget to create a viewport." );
