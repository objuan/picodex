...
namespace UnityEngine
{
    ...
    public static class Mathf
    {
        ...
        public static readonly float Deg2Rad = (float)System.Math.PI / 180.0f;
        public static readonly float Rad2Deg = 180.0f / (float)System.Math.PI;
        ...
        public static float Lerp(float from, float to, float blend)
        {
            return blend * (to - from) + from;
        }
