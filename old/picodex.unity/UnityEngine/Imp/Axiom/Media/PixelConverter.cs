...
namespace Axiom.Media
{
	...
	public class PixelConverter
	{
		...
		public static void PackColor( UnityEngine.Color color, PixelFormat format, IntPtr dest )
		{
			unsafe
			{
		...
		public static UnityEngine.Color UnpackColor( PixelFormat pf, IntPtr src )
		{
