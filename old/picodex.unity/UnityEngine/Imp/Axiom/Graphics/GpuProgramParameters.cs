...
//     <id value="$Id: GpuProgramParameters.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
	...
	public partial class GpuProgramParameters
	{
		...
		public void SetConstant( int index, UnityEngine.Color color )
		{
			if( color != null )
			{
		...
		/// <param name="index">Index of the contant register.</param>
		/// <param name="val">Structure containing 3 packed float values.</param>
		public void SetConstant( int index, Matrix4x4 val )
		{
			Matrix4x4 mat;
		...
		/// <param name="index">Index of the contant register.</param>
		/// <param name="val">Structure containing 3 packed float values.</param>
		public void SetConstant( int index, Matrix4x4[] matrices, int count )
		{
		...
		/// <param name="name">Name of the param.</param>
		/// <param name="color">Structure containing 4 packed RGBA color values.</param>
		public void SetNamedConstant( string name, UnityEngine.Color color )
		{
			int index = GetParamIndex( name );
			if( index != -1 )
			{
		...
		/// <param name="name">Name of the param.</param>
		/// <param name="val">Structure containing 3 packed float values.</param>
		public void SetNamedConstant( string name, Matrix4x4 val )
		{
			int index = GetParamIndex( name );
			if( index != -1 )
			{
		...
		public void SetNamedConstant( string name, Matrix4x4[] matrices, int count )
		{
			int index = GetParamIndex( name );
			if( index != -1 )
			{
