...
//     <id value="$Id: ViewportCollection.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Axiom.Collections
{
	...
	public class ViewportCollection : AxiomSortedCollection<int, Viewport>
	{
		...
		{
			UnityEngine.Debug.Assert( !ContainsKey( item.ZOrder ), "A viewport with the specified ZOrder " + item.ZOrder + " already exists." );
