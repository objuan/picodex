...
namespace Picodex
{
    public class PathUtils
    {
        ...
        public static string GenerateRandomVoxelDatabaseName()
        {
            ...
            return randomIntGenerator.Next().ToString("X8") + ".vxcm";
        }
        ...
        {
            get { return Application.streamingAssetsPath + "/Picodex/SDK"; }
        }
        ...
        {
            get { return Application.streamingAssetsPath + "/Picodex/VoxelDatabases"; }
        }
        ...
        {
            get { return Application.streamingAssetsPath + "/Picodex/VoxelDatabases/CreatedForAssets"; }
        }
    }
