...
//     <id value="$Id: HighLevelGpuProgram.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
	...
	abstract public class HighLevelGpuProgram : GpuProgram, IConfigurable
	{
		...
		protected override void load()
		{
			...
			UnityEngine.Debug.Assert( assemblerProgram != null, "Subclasses of HighLevelGpuProgram MUST initialize the low level assembler program." );
