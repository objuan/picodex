...
//     <id value="$Id: Material.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
	...
	public class Material : Resource, IComparable
	{
		...
		{
			this.SetFog( overrideScene, FogMode.None, Color.White, 0.001f, 0.0f, 1.0f );
		}
		...
		public void SetLodLevels( LodValueList lodDistanceList )
		{
			...
			foreach( float lodValue in lodDistanceList )
			{
