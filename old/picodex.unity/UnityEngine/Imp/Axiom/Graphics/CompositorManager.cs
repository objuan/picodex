...
namespace Axiom.Graphics
{
	...
	public class CompositorManager : ResourceManager, ISingleton<CompositorManager>
	{
		...
		/// </summary>
		public static CompositorManager Instance { get { return Singleton<CompositorManager>.Instance; } }
		...
		public bool Initialize( params object[] args )
		{
			...
			chains = new Dictionary<Rect, CompositorChain>();
		...
		///</summary>
		protected Dictionary<Rect, CompositorChain> chains;
		...
		/// List of registered compositor logics
		/// </summary>
		public ReadOnlyDictionary<string, ICompositorLogic> CompositorLogics { get { return compositorLogicIndex; } }
		...
		/// List of registered custom composition passes
		/// </summary>
		public ReadOnlyDictionary<string, ICustomCompositionPass> CustomCompositionPasses { get { return customCompositionPassesIndex; } }
		...
		///<summary>
		///    Get the compositor chain for a Rect. If there is none yet, a new
		///    compositor chain is registered.
		///    XXX We need a _notifyRectRemoved to find out when this viewport disappears,
		///    so we can destroy its chain as well.
		///</summary>
		public CompositorChain GetCompositorChain( Rect vp )
		{
		...
		///</summary>
		public bool HasCompositorChain( Rect vp )
		{
		...
		///</summary>
		public void RemoveCompositorChain( Rect vp )
		{
			chains.Remove( vp );
		}
		...
		///</summary>
		///<param name="vp">Rect to modify</param>
        ...
        public CompositorInstance AddCompositor(Rect vp, string compositor, int addPosition)
		{
		...
		public CompositorInstance AddCompositor( Rect vp, string compositor )
		{
		...
		///</summary>
		public void RemoveCompositor( Rect vp, string compositor )
		{
			CompositorChain chain = GetCompositorChain( vp );
		...
		///</summary>
		public void SetCompositorEnabled( Rect vp, string compositor, bool value )
		{
			CompositorChain chain = GetCompositorChain( vp );
			for( int i = 0; i < chain.Instances.Count; i++ )
			{
