...
namespace Axiom.Graphics
{
	...
	public class Pass
	{
		...
		/// Emissive color in fixed function passes.
		/// </summary>
		public Color Emissive { get { return _emissive; } set { _emissive = value; } }

		/// <summary>
		/// Emissive color in fixed function passes.
		/// </summary>
		public Color SelfIllumination { get { return _emissive; } set { _emissive = value; } }
		...
		///    Only valid if FogOverride is true.
		/// </remarks>
		public Color FogColor { get { return _fogColor; } protected set { _fogColor = value; } }
		...
		public bool IsAmbientOnly
		{
			get
			{
				...
				return ( !_lightingEnabled ||
				         !_colorWriteEnabled ||
				         ( _diffuse == Color.Black && _specular == Color.Black ) );
			}
		}
		...
		///    Only applicable if mode is FogMode.Linear.
		/// </param>
		public void SetFog( bool overrideScene, FogMode mode, Color color, float density, float start, float end )
		{
		...
		{
			SetFog( overrideScene, FogMode.None, Color.White, 0.001f, 0.0f, 1.0f );
		}
		...
		{
			SetFog( overrideScene, mode, Color.White, 0.001f, 0.0f, 1.0f );
		}
		...
		///    The default is 0.001.
		/// </param>
		public void SetFog( bool overrideScene, FogMode mode, Color color, float density )
		{
