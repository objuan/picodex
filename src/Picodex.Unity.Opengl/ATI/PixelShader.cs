...
//     <id value="$Id: PixelShader.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.OpenGL.ATI
{
	...
	public class PixelShader : Compiler2Pass
	{
		...
		private static MacroRegModify texreg2ar_MacroMods =
		...
		private static MacroRegModify texreg2gb_MacroMods =
		...
		private static MacroRegModify texdp3_MacroMods =
		...
		private static MacroRegModify texdp3tex_MacroMods =
		...
		private static MacroRegModify texm3x2pad_MacroMods =
		...
		private static MacroRegModify texm3x2tex_MacroMods =
		...
		private static MacroRegModify texm3x3pad_MacroMods =
		...
		private static MacroRegModify texm3x3tex_MacroMods =
		...
		private static MacroRegModify texm3x3spec_MacroMods =
		...
		*/
		...
		private bool Pass2scan( TokenInstruction[] Tokens, int size )
		{
		...
		*/
		private bool BindMachineInstInPassToFragmentShader( IntList PassMachineInstructions )
		{
			int instIDX = 0;
		...
		*/
		...
		private bool ExpandMacro( MacroRegModify MacroMod )
		{
			RegModOffset regmod;
		...
		*/
		...
		private bool ExpandMachineInstruction()
		{
		...
		private bool IsRegisterReadValid( PhaseType phase, int param )
		{
		...
		public bool RunTests()
		{
			...
			Symbol[] CompileTest6result = {
			                              	Symbol.PS_1_4, Symbol.MOV, Symbol.R0, Symbol.RBA, Symbol.COMMA, Symbol.C1,
