...
namespace Axiom.Graphics
{
	partial class GpuProgramParameters
	{
		...
		public class GpuSharedParameters
		{
			...
			/// <param name="name"></param>
			/// <param name="value"></param>
			public void SetNamedConstant( string name, Matrix4x4 value )
			{
				this.SetNamedConstant( name, BitConverterEx.GetBytes( value ), true );
			}
			...
			/// <param name="name"></param>
			/// <param name="value"></param>
            public void SetNamedConstant(string name, Matrix4x4 value, int numEntries)
			{
				this.SetNamedConstant( name, BitConverterEx.GetBytes( value ), true );
			}
			...
			/// <param name="name"></param>
			/// <param name="value"></param>
			public void SetNamedConstant( string name, UnityEngine.Color value )
			{
				this.SetNamedConstant( name, BitConverterEx.GetBytes( value ), true );
			}
