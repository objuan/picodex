...
//     <id value="$Id: ShadowRenderable.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
	...
	abstract public class ShadowRenderable : DisposableObject, IRenderable
	{
		...
		abstract public void GetWorldTransforms( Matrix4[] matrices );
		...
		abstract public Quaternion WorldOrientation { get; }

		abstract public Vector3 WorldPosition { get; }
