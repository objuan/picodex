...
namespace Axiom.Graphics
{
	...
	public class CompositorChain
	{
		public class RQListener
		{
            ...
            public Rect Viewport { set { viewport = value; } }
        ...
        public Rect Viewport { get { return viewport; } set { viewport = value; } }
		...
		public CompositorChain( Rect vp )
		{
			this.viewport = vp;
			originalScene = null;
		...
		///</summary>
		protected void PreTargetOperation( CompositeTargetOperation op, Rect vp, Camera cam )
		{
		...
		///</summary>
		protected void PostTargetOperation( CompositeTargetOperation op, Rect vp, Camera cam )
		{
			SceneManager sm = cam.SceneManager;
