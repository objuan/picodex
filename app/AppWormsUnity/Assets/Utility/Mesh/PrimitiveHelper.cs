...
namespace Picodex
{
    ...
    public static class IcoSphere
    {
        ...
        public static void Create(Mesh mesh, float radius = 1f,int recursionLevel = 3)
        {
    ...
    public static class PrimitiveHelper
    {
        ...
        private static void CreatePrimitiveMesh(Mesh mesh, PrimitiveType type, float size = 1)
        {
            ...
            else if (type == PrimitiveType.IsoSphere)
            {
                CreateIsoSphere(mesh, size,3);
                mesh.name = "IsoSphere";
            }
        ...
        public static void CreateIsoSphere(Mesh mesh, float radius = 1f, int recursionLevel = 3)
        {
            IcoSphere.Create(mesh, radius, recursionLevel);
        }
    ...
    3 + 4 * 5, 2 + 4 * 5, 1 + 4 * 5,
        ...
        public static void CreateQuad(Mesh mesh, Vector3[] vertices)
        {
            //Vector3[] vertices = new Vector3[]
            //{
            //new Vector3( 1, 0,  1),
