...
//     <id value="$Id: RenderTarget.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Axiom.Graphics
{
	...
	abstract public class RenderTarget : DisposableObject
	{
		...
		{
			UnityEngine.Debug.Assert( index >= 0 && index < _viewportList.Count );
		...
		protected void updateStatistics()
		{
			...
			_statistics.BestFrameTime = UnityEngine.Utility.Min( _statistics.BestFrameTime, frameTime );
            _statistics.WorstFrameTime = UnityEngine.Utility.Max(_statistics.WorstFrameTime, frameTime);
			...
			if( thisTime - _lastSecond > 1000 )
			{
				...
				_statistics.BestFPS = UnityEngine.Utility.Max( _statistics.BestFPS, _statistics.LastFPS );
				_statistics.WorstFPS = UnityEngine.Utility.Min( _statistics.WorstFPS, _statistics.LastFPS );
