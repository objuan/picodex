...
namespace UnityEngine
{
    ...
    {
        internal Imp.MeshView _meshView;
        internal Imp.RenderableObject _renderableObject;

        internal static int meshCount = 0;
       ...
       // Returns a copy of the vertex positions or assigns a new vertex positions array. 
        ...
        public Mesh()
        {
            _renderableObject = new UnityEngine.Imp.RenderableObject();
            _meshView = _renderableObject.MeshView;
        }
