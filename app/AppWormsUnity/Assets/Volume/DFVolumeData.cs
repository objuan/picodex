...
namespace Picodex
{
	...
	public class DFVolumeData : ScriptableObject
	{
        ...
        public float distanceFieldRangeMin {
            get { return volume.DistanceFieldRangeMin;  }
        }

        public float distanceFieldRangeMax
        {
            get { return volume.DistanceFieldRangeMax; }
        }
		...
		public string fullPathToVoxelDatabase
		{
			get
			{
				...
				case VoxelDatabasePaths.Streaming:
					basePathString = PathUtils.voxelDatabases + '/';
					break;
