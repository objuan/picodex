...
//     <id value="$Id: GLRenderSystem.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
using Real = UnityEngine.Real;
using Utility = UnityEngine.Utility;
...
namespace Axiom.RenderSystems.OpenGL
{
	...
	public class GLRenderSystem : RenderSystem
	{
		...
		public override void ApplyObliqueDepthProjection( ref Matrix4 projMatrix, UnityEngine.Plane plane, bool forGpuProgram )
		{
		...
		public override void SetTexture( int stage, bool enabled, Texture texture )
		{
			...
			//Gl.glActiveTextureARB( Gl.GL_TEXTURE0 + stage );
            Gl.glActiveTexture(Gl.GL_TEXTURE0 + stage);
