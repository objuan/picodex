...
namespace UnityEngine
{
    ...
    public class IDerivedPlaneProvider
    {
	...
	public class Frustum //: MovableObject, IRenderable
	{
		...
		/// </remarks>
		protected Matrix4x4 _projectionMatrixRS;
		...
		/// </remarks>
        virtual public Matrix4x4 ProjectionMatrixRS
		{
			get
			{
				UpdateFrustum();
		...
		/// </remarks>
		protected Matrix4x4 _projectionMatrixRSDepth;
		...
		/// </remarks>
        virtual public Matrix4x4 ProjectionMatrixRSDepth
		{
			get
			{
				UpdateFrustum();
		...
		/// </summary>
        virtual public Matrix4x4 ProjectionMatrix
		{
			get
			{
				UpdateFrustum();
		...
		/// </summary>
        virtual public Matrix4x4 ViewMatrix
		{
			get
			{
				UpdateView();
		...
		/// </summary>
        virtual public Matrix4x4 ReflectionMatrix { get { return _reflectionMatrix; } protected set { _reflectionMatrix = value; } }
	...
	//	protected LightList dummyLightList = new LightList();
		...
		private void Initialize()
		{
            ...
            _projectionMatrixRS = Matrix4x4.Zero;
		...
		{
			SetCustomViewMatrix( enable, Matrix4x4.Identity );
		}

        public void SetCustomViewMatrix(bool enable, Matrix4x4 viewMatrix)
		{
		...
		{
            SetCustomProjectionMatrix(enable, Matrix4x4.Identity);
		}

        public void SetCustomProjectionMatrix(bool enable, Matrix4x4 projMatrix)
		{
		...
		protected void CalculateProjectionParameters( out float vpLeft, out float vpRight, out float vpBottom, out float vpTop )
		{
			if( _customProjectionMatrix )
			{
				...
				Matrix4x4 invProj = _projectionMatrix.Inverse();
		...
		virtual protected void _updateFrustumPlanes()
		{
			...
			// -------------------------
			Matrix4x4 combo = _projectionMatrix * _viewMatrix;
		...
		{
            Matrix4x4 eyeToWorld = _viewMatrix.InverseAffine();
			...
			float ratio = _projectionType == Projection.Perspective ? _farDistance / _nearDistance : 1;
		...
		/// </summary>
		public AxisAlignedBox BoundingBox { get { return _boundingBox; } }

		/// <summary>
		///
		/// </summary>
		/// <param name="camera"></param>
		public void NotifyCurrentCamera( Camera camera )
		{
			// do nothing
		}
	...
	//	public Material Material { get { return _material; } }
		...
		public void GetWorldTransforms( Matrix4x4[] matrices )
		{
            //if( parentNode != null )
            //{
