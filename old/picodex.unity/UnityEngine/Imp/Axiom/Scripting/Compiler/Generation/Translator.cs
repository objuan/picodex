...
namespace Axiom.Scripting.Compiler
{
	public partial class ScriptCompiler
	{
		abstract public class Translator
		{
			...
			/// <returns></returns>
			abstract internal bool CheckFor( Keywords nodeId, Keywords parentId );
			...
			abstract public void Translate( ScriptCompiler compiler, AbstractNode node );
			...
			/// <see cref="getColor(IList&lt;AbstractNode&gt;, int, UnityEngine.Color, int)"/>
			protected static bool getColor( IList<AbstractNode> nodes, int i, out UnityEngine.Color result )
			{
			...
			/// <returns>true if successful</returns>
			protected static bool getColor( IList<AbstractNode> nodes, int i, out UnityEngine.Color result, int maxEntries )
			{
				...
				result = new UnityEngine.Color( vals[ 0 ], vals[ 1 ], vals[ 2 ], vals[ 3 ] );
			...
			/// <param name="m"></param>
			/// <returns>true if successful</returns>
			protected static bool getMatrix4( IList<AbstractNode> nodes, int i, out UnityEngine.Matrix4x4 m )
			{
                m = new UnityEngine.Matrix4();
