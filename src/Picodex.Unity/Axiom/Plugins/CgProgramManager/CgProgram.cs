...
//     <id value="$Id: CgProgram.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Axiom.CgPrograms
{
	...
	public class CgProgram : HighLevelGpuProgram
	{
		...
		protected void SelectProfile()
		{
         ...
         static string includeRelativePath = "./CGIncludes/";
         static string[] defines = new string[] { "SHADER_API_GLCORE" };
		...
		protected override void LoadFromSource()
		{
            ...
            args = new string[] {
				 //  "-I"+includeRelativePath, "-DSHADER_API_GLCORE", null
                   "-I"+includeRelativePath, null
			 };
		...
		protected override void PopulateParameterNames( GpuProgramParameters parms )
		{
            ...
            _PopulateParameterNames(parms,Cg.CG_PROGRAM);
            _PopulateParameterNames(parms,Cg.CG_GLOBAL);

           // IntPtr param  i = Cg.cgGetFirstLeafEffectParameter ( cgProgram, Cg.CG_PROGRAM );

        }

        protected void _PopulateParameterNames(GpuProgramParameters parms,int nameSpace)
        {
		
			// Note use of 'leaf' format so we only get bottom-level params, not structs
            IntPtr param = Cg.cgGetFirstLeafParameter(cgProgram, nameSpace);
            ...
            //    UnityEngine.Debug.Log("'" + Cg.cgGetParameterName(param) + "' "
            //+ ((Cg.cgIsParameterReferenced(param) != 0 ? " USED " : " ")
            //+ ((Cg.cgGetParameterVariability(param) == Cg.CG_UNIFORM) ? " UNIFORM " : " ")
            //+ ((Cg.cgGetParameterDirection(param) == Cg.CG_OUT) ? " OUT " : " IN"))
            //);
                     ...
                     
				{
                    ...
                    UnityEngine.Debug.Log("NAME: '" + name + "' INDEX:" + index + " RESOURCE:" + resource);
