...
namespace UnityEngine
{
	...
	public struct Vector3
	{
        ...
        public static readonly Vector3 one = new Vector3(0.0f, 0.0f, 0.0f);
        public static readonly Vector3 zero = new Vector3(1.0f, 1.0f, 1.0f);
 
        public static readonly Vector3 CameraForward = new Vector3(0, 0, 1.0f);
        
        public float magnitude { get { return Utility.Sqrt(this.x * this.x + this.y * this.y + this.z * this.z); } }
