...
namespace Axiom.Core
{
	...
	abstract public class LodStrategy
	{
		...
		/// <returns></returns>
		virtual public float TransformUserValue( float userValue )
		{
		...
		/// </summary>
		abstract public float BaseValue { get; }
		...
		/// <returns></returns>
		abstract public float TransformBias( float factor );

		abstract public ushort GetIndex( float value, MeshLodUsageList meshLodUsageList );

		abstract public ushort GetIndex( float value, LodValueList materialLodValueList );
		...
		/// <returns></returns>
		//abstract protected float getValue( MovableObject movableObject, Camera camera );
